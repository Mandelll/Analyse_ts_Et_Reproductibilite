...
Ainsi, l'utilisation de la fonction auto.arima avec un horizon prévisionnel égale à la longueur de hawai_ts_test permet d'aboutir au modèle suivant :
 
```{r echo = FALSE, fig.dim= c(12, 10)}
hawai_model_arima <- hawai_ts_train %>% auto.arima(approximation = T)
